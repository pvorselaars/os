...
void memory_copy(void *dest, const void *src, const uint64_t size)
{
    arch_memory_copy(dest, src, size);
}

void memory_move(void *dest, const void *src, const uint64_t size)
{
    arch_memory_move(dest, src, size);
}

int memory_compare(const void *ptr1, const void *ptr2, const uint64_t size)
{
    return arch_memory_compare(ptr1, ptr2, size);
}
